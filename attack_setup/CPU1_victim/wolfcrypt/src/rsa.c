    ...
    int saltLen, int bits, void* heap)
{
    ...
    switch (padType)
    {
        ...
        case WC_RSA_NO_PAD:
        	printf("wolfSSL Using NO padding\n\r");
    ...
    switch (key->state) {
        ...
        case RSA_STATE_DECRYPT_UNPAD:
           ...
           /* printf("end: \n\r");
            ...
            for(int i = 0 ; i <         printf("success = 0 ? => %d\n\r",ret);256 ; i++)
            {
            	printf("%02x ",out[i]);
            }*/
                            ...
                            WC_RNG* rng)
{
    ...
    case RSA_STATE_DECRYPT_EXPTMOD:
        ...
        ret = wc_RsaFunction(key->data, inLen, key->data, &key->dataLen,rsa_type, key, rng);
    	/*printf("\n\rafter decryption: \n\r");
        for(int i = 0 ; i < 256 ; i++)
    	{
    		printf("%02x ",key->data[i]);
                                                     ...
                                                     RsaKey* key, WC_RNG* rng)
{
    ...
    //return RsaPublicEncryptEx(in, inLen, out, outLen, key,RSA_PUBLIC_ENCRYPT, RSA_BLOCK_TYPE_2, WC_RSA_PKCSV15_PAD,WC_HASH_TYPE_NONE, WC_MGF1NONE, NULL, 0, 0, rng);
	return RsaPublicEncryptEx(in, inLen, out, outLen, key,RSA_PUBLIC_ENCRYPT, RSA_BLOCK_TYPE_2, WC_RSA_NO_PAD,WC_HASH_TYPE_NONE, WC_MGF1NONE, NULL, 0, 0, rng);
}
...
int wc_RsaPrivateDecryptInline(byte* in, word32 inLen, byte** out, RsaKey* key)
{
    ...
    return RsaPrivateDecryptEx(in, inLen, in, inLen, out, key,
        RSA_PRIVATE_DECRYPT, RSA_BLOCK_TYPE_2, WC_RSA_NO_PAD,
