...
WOLFSSL_LOCAL int sp_RsaPrivate_1024_custom_naive(const byte* in, word32 inLen, mp_int* dm, mp_int* nm, byte* out, word32 outLen);
WOLFSSL_LOCAL int sp_RsaPrivate_1024_custom_constanttime(const byte* in, word32 inLen, mp_int* dm, mp_int* nm, byte* out, word32 outLen);
WOLFSSL_LOCAL int sp_RsaPrivate_1024_custom_montgomeryladder(const byte* in, word32 inLen, mp_int* dm, mp_int* nm, byte* out, word32 outLen);
WOLFSSL_LOCAL int sp_RsaPrivate_1024_custom_montgomeryladder2(const byte* in, word32 inLen, mp_int* dm, mp_int* nm, byte* out, word32 outLen);
WOLFSSL_LOCAL int sp_RsaPrivate_2048_custom_montgomeryladder(const byte* in, word32 inLen, mp_int* dm, mp_int* nm, byte* out, word32 outLen);
